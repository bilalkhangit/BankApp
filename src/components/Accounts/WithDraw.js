...
class WithDraw extends Component {
    ...
    WithDraw = () => {
            ...
            const amt = this.refs.Amount.value;
            if(amt <= balance)
            {
                balance = balance - amt;
            ...
            {
                   alert(`Please enter the amount less than or equal than balance`);
            }
    ...
    Transaction = (Account,Amount) => {
        ...
        const Trans = this.CreateTrans(random_number, Account, "Debit",Amount,Time);
        const arr = [];
        if(PrevTrans != null)
        { 
                        ...
                        <div class="shadow-sm mt-3 bg-white rounded">
                            ...
                            <form>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label ml-2">Amount to withdraw*</label>
                                    <div class="col-sm-8 col-11 ml-2">
                                        <input type="text" class="form-control" ref="Name" placeholder="Amount to withdraw" ref="Amount" />
                                    </div>
                                </div>
                                <hr />
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-5 col-md-5 col-lg-3  mb-4">
                                        <button type="button" className="btn btn-Accounts-WithDraw-Plus ml-2  col-11" onClick={() => { this.WithDraw() }}>WithDraw</button>
                                    </div>
                                    <div class="col-sm-5 col-md-5  col-lg-3 mb-4">
